...
typedef enum {
    VERBOSE_LEXER = 1 << 0,
    VERBOSE_PARSER = 1 << 1,
    VERBOSE_SEMANTIC = 1 << 2,
    VERBOSE_BYTECODE = 1 << 3,
    VERBOSE_CODEGEN = 1 << 4,
} VerboseFlags;

extern VerboseFlags verbose;
...
typedef enum {
    ...
    AST_DECLARATION_ENUM_PLACEHOLDER, // The parser de-sugars this into an alias and constants.
...
SemanticContext *sema_initialize(void);
